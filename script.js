    ...
    sendMessage: function() {
        ...
        .then(function(data) {
            ...
            if (data.response && data.response.toLowerCase().includes('файл')) {
                self.addMessage("Отлично! Понимаем, что вы настроены серьезно. Для подготовки КП загрузите заявку и реквизиты — нажмите загрузить файл 👇 или просто напишите: файл", 'bot', [
