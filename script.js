    ...
    sendMessage: function() {
        ...
        .then(function(data) {
            ...
            if (data.response && data.response.toLowerCase().includes('файл')) {
                self.addMessage("Отлично! Видим, что вы настроены серьезно и готовы помочь вам с подготовкой КП. 
                    Для этого вы можете загрузить заявку и реквизиты — просто нажмите кнопку "Файл" 👇 или напишите в чате слово "файл". 
                    Мы ценим ваше время и сделаем процесс максимально удобным для вас.", 'bot', [
